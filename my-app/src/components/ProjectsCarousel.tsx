            ...
            >
              <Card className="group h-full glass-effect border-slate-700/50 relative overflow-hidden">
                ...
                <div className="relative aspect-video overflow-hidden">
                  ...
                  {/* Always-visible corner CTA */}
                  <div className="absolute bottom-3 right-3 z-10">
                    <Link to={project.link}>
                      <Button size="sm" variant="outline" className="bg-slate-900/70 border-slate-600 text-white hover:bg-slate-800">
                        Project Details
                      </Button>
                    </Link>
                  </div>
                ...
                <CardContent className="p-4 space-y-3">
                  ...
                  {/* Inline CTA below content for visibility on mobile */}
                  <div className="pt-2">
                    <Link to={project.link}>
                      <Button size="sm" className={`bg-gradient-to-r ${project.gradient} hover:opacity-90 border-0`}>
                        <ExternalLink className="w-4 h-4 mr-2" />
