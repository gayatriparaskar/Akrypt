  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 w-full z-50  transition-colors ${
        scrolled ? "bg-slate-900/80 border-b border-slate-800/70" : "glass-effect border-b border-slate-800/50"
      }`}
    >
        ...
        <div className="flex justify-between items-center py-2">
          ...
          >
            <Link to="/" className="flex items-center space-x-4 group">
                <div className="relative h-9 w-9 transition-transform duration-300">
                <div className="absolute inset-0 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full  opacity-75 group-hover:opacity-100 transition-opacity"></div>
                ...
                <div className="relative bg-white p-1 rounded-full h-10 w-10 shadow-2xl border-2 border-purple-300/50 group-hover:border-purple-400 transition-colors">
                  {/* <img
              ...
              <div className="flex flex-col">
                <span className="text-xl font-black bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 bg-clip-text text-transparent group-hover:from-purple-300 group-hover:via-pink-300 group-hover:to-blue-300 transition-all duration-300">
                  Akrypt IT Solutions
                </span>
            ...
            {navigation.map((item, index) => (
              ...
              >
                <a
                  ...
                  className={`transition-colors duration-300 font-medium relative group cursor-pointer text-sm md:text-base ${
          ...
          >
            ...
            >
              ...
              <Button
                ...
                className="relative bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-semibold border-0 px-5 py-2 cursor-pointer"
              >
