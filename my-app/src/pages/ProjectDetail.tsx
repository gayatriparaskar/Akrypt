...
import fintech2 from "../assests/fintech 2.avif";
import fintech3 from "../assests/fintech 3.avif";
import healthcare from "../assests/healthCare.jpeg";
import healthCare2 from "../assests/healthCare 2.avif";
import healthCare3 from "../assests/healthCare 3.avif";
import elearningPlatform from "../assests/elearning Platform.avif";
import elearingPlatform2 from "../assests/elearning Platform 2.avif";
import elearingPlatform3 from "../assests/elearning Platform 3.avif";
import elearningPlatform1 from "../assests/elearning Platform 1.avif";
import logistic1 from "../assests/logistics 1.jpeg";
import logistic2 from "../assests/logistic 2.jpeg";
import logistic3 from "../assests/logistic 3.jpeg";
import logistic from "../assests/logistics.avif";
import restaurant from "../assests/restaurant.avif";
import restaurant2 from "../assests/restaurant 2.jpeg";
import restaurant3 from "../assests/restaurant 1.jpeg";
import cryptoExchange from "../assests/crypto-exchange.webp";
import cryptoExchange1 from "../assests/crypto-exchange 1.jpeg";
import cryptoExchange2 from "../assests/crypto-exchange 2.jpeg";
import cryptoExchange3 from "../assests/crypto-exchange 3.jpeg";
import hotelBooking from "../assests/hotel booking.avif";
import hotelBooking2 from "../assests/hotel booking 2.jpeg";
import hotelBooking3 from "../assests/hotel booking 1.jpeg";
import sochSarees from "../assests/soch-sarees.avif";
import sochSarees2 from "../assests/soch-sarees 2.jpeg";
import sochSarees3 from "../assests/soch-sarees 1.jpeg";
import rangritiFashion from "../assests/rangriti-fashion.webp";
import rangritiFashion1 from "../assests/rangriti-fashion 1.jpeg";
import rangritiFashion2 from "../assests/rangriti-fashion 2.jpeg";
import rangritiFashion3 from "../assests/rangriti-fashion 3.webp";
import adeshEnterprises from "../assests/andesh-enterprises.avif";
import adeshEnterprises2 from "../assests/andesh-enterprise 2.webp";
import adeshEntrprises3 from "../assests/andesh-enterprise 3.webp";
import mangatramJewelers from "../assests/mangatram-jewelers.avif";
import mangatramJewelers1 from "../assests/mangatram-jewelers 1.jpeg";
...
const projectsData: Record<string, ProjectData> = {
  "fintech-dashboard": {
    ...
    longDescription:
      "A sophisticated financial analytics platform that provides real-time market data, advanced charting capabilities, and comprehensive trading insights. Built for institutional investors and trading firms requiring high-performance data visualization and analytics.",
    image: fintech,
    tech: [
      "React",
      "TypeScript",
    ...
    gallery: [fintech, fintech2, fintech3],
  },
  "healthcare-system": {
    ...
    longDescription:
      "A complete healthcare management solution designed for medical practices and hospitals. Features comprehensive patient management, appointment scheduling, electronic health records, and integrated billing systems to streamline healthcare operations.",
    image: healthcare,
    tech: [
      "Next.js",
      "PostgreSQL",
    ...
    gallery: [healthcare, healthCare2, healthCare3],
  },
  "elearning-platform": {
    ...
    longDescription:
      "An advanced e-learning platform that leverages artificial intelligence to deliver personalized learning experiences. Features adaptive content delivery, intelligent progress tracking, and comprehensive analytics to optimize learning outcomes for students and educators.",
    ...
    gallery: [elearingPlatform2, elearingPlatform3, elearningPlatform1],
  },
  "logistics-tracker": {
    ...
    longDescription:
      "A comprehensive logistics management platform that provides real-time tracking, route optimization, and inventory management. Designed for logistics companies to streamline operations, reduce costs, and improve delivery efficiency.",
    image: logistic,
    ...
    gallery: [logistic1, logistic2, logistic3],
  },
  "restaurant-pos": {
    id: "restaurant-pos",
    ...
    longDescription:
      "A comprehensive restaurant point-of-sale system that streamlines operations from order taking to payment processing. Features advanced inventory management, customer analytics, and integrated payment solutions designed specifically for the food service industry.",
    image: restaurant,
    tech: [
      "React Native",
      "Firebase",
    ...
    gallery: [restaurant, restaurant2, restaurant3],
  },
  "crypto-exchange": {
    id: "crypto-exchange",
    ...
    longDescription:
      "A secure and scalable cryptocurrency exchange platform offering spot trading, advanced charting tools, and comprehensive portfolio management. Built with enterprise-grade security and high-performance trading engine to handle millions of transactions.",
    ...
    gallery: [cryptoExchange1, cryptoExchange2, cryptoExchange3],
  },
  "hotels-booking": {
    id: "hotels-booking",
    ...
    longDescription:
      "A sophisticated hotel booking platform that provides real-time room availability, competitive pricing, and secure reservation management. Built for travelers seeking seamless accommodation booking experiences with advanced search filters and location-based recommendations.",
    image: hotelBooking,
    tech: [
      "React",
      "Node.js",
    ...
    gallery: [hotelBooking, hotelBooking2, hotelBooking3],
  },
  "soch-sarees": {
    id: "soch-sarees",
    ...
    longDescription:
      "An elegant e-commerce platform for premium saree collections featuring advanced filtering, virtual try-on technology, and personalized styling recommendations. Designed to enhance the traditional saree shopping experience with modern technology.",
    image: sochSarees,
    tech: [
      "React",
      "Redux",
    ...
    gallery: [sochSarees, sochSarees2, sochSarees3],
  },
  "rangriti-fashion": {
    id: "rangriti-fashion",
    ...
    longDescription:
      "A modern platform for contemporary ethnic fashion that combines traditional aesthetics with cutting-edge technology. Features machine learning-powered recommendations and virtual styling assistance to help customers discover their perfect ethnic wear.",
    ...
    gallery: [rangritiFashion1, rangritiFashion2, rangritiFashion3],
  },
  "adesh-enterprises": {
    ...
    longDescription:
      "A comprehensive B2B portal designed for industrial equipment and machinery suppliers. Features advanced inventory management, supplier networks, and enterprise-grade security for seamless business operations and supply chain management.",
    ...
    gallery: [adeshEnterprises, adeshEnterprises2, adeshEntrprises3],
  },
  "mangatram-jewelers": {
    ...
    longDescription:
      "An exclusive online platform for luxury jewelry featuring immersive 360° product visualization, custom design tools, and virtual try-on capabilities. Designed to bring the premium jewelry shopping experience to the digital realm with cutting-edge technology.",
    ...
    gallery: [mangatramJewelers1, mangatramJewelers2, mangatramJewelers3],
  },
};
...
export default function ProjectDetail() {
  ...
  if (!project) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-700 via-indigo-600 to-blue-500 flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="bg-white/10 backdrop-blur-md rounded-2xl shadow-2xl p-10 max-w-lg w-full text-center border border-white/20 animate-fadeIn">
          {/* Icon or Illustration */}
          <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-white/20 flex items-center justify-center shadow-lg animate-bounce-slow">
            <svg
            ...
            >
              <path
                ...
                d="M9.75 17L4.5 12.75l5.25-4.25m9 8.5l5.25-4.25-5.25-4.25M15 21v-2a4 4 0 00-4-4H5m14-4v-2a4 4 0 00-4-4h-6"
              />
            </svg>
          </div>
          ...
          <p className="text-white/80 text-lg mb-8">
            The project you’re looking for doesn’t exist or might have been
            removed.
          </p>

          {/* Button */}
          <Link to="/">
            <Button className="bg-white text-indigo-600 font-semibold px-6 py-3 rounded-full shadow-lg hover:scale-105 hover:shadow-2xl transition-all duration-300">
        ...
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground">
              Explore the comprehensive features that make this project stand
              out.
            </p>
          </motion.div>
